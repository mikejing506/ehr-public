...
class PreOrderCUS extends React.Component {
    ...
    _handleLogin = () =>{
        ...
        .send({uid:this.state.user.ID,from:this.state.from,to:this.state.to,class:5})
        .end((err,res)=>{
            if (err) throw err;
                ...
                <div className={classes.panels}>
                    ...
                    <Paper elevation={5} style={{marginBottom:20}}>
                        <ListItem button>
                            ...
                            <div style={{ float: 'right',width:'74%', right:0}}>
                                <TextField
                                    required
                                    id="required"
                    ...
                    <Paper elevation={5} style={{ marginBottom: 20 }}>
                        <ListItem button>
                            <Typography variant="subheading" component="h3" style={{ marginRight: 10 }}>
                               <img src={noteIcon} style={{ marginRight: 5 }} /> Note
                            </Typography>
                            <div style={{ float: 'right', width: '80%', right: 0 }}>
                                <TextField
                                    required
                                    id="required"
                                    multiline
...
PreOrderCUS.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withRouter(withRoot(withStyles(styles)(PreOrderCUS)));
