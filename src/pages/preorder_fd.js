...
class PreOrderFD extends React.Component {
    ...
    _handleLogin = () => {
        request
            ...
            .send({ uid: this.state.user.ID, from: this.state.from, to: this.state.to, class: 3 })
            .end((err, res) => {
                if (err) throw err;
...
PreOrderFD.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withRouter(withRoot(withStyles(styles)(PreOrderFD)));
