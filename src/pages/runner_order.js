...
class RunnerOrder extends React.Component {
    state = {
        open: false,
        left: false,
        data: []
    ...
    componentWillMount() {
        ...
        request.post(config.server + '/runner/orderlist').send({ id: JSON.parse(localStorage.getItem('userdata')).ID}).end((err,res)=>{
            if (err) throw err;
    ...
    render() {
        ...
        return (
            <div className={classes.root} >
                ...
                >
                    <Toolbar>
                        <Link to="/runner" style={{ color: "#FFF" }}>
...
RunnerOrder.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withRoot(withStyles(styles)(RunnerOrder));
