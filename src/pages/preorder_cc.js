...
class PreOrderCC extends React.Component {
    ...
    _handleLogin = () =>{
        ...
        .send({uid:this.state.user.ID,from:this.state.from,to:this.state.to,class:4})
        .end((err,res)=>{
            if (err) throw err;
...
PreOrderCC.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withRouter(withRoot(withStyles(styles)(PreOrderCC)));
